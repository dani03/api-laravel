...
class ProjectController extends Controller
{
    ...
    {
        return response(['project' => new ProjectResource($project), 'message' => 'this is the user'], 200);
    }
    ...
    public function update(Request $request, Project $project)
    {
        ...
        return response(['project' => new ProjectResource($project), 'message' => 'updated magifically']);
    }
